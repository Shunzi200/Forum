    ...
    var body: some View {
        GeometryReader{geometry in
            ZStack (alignment: .top){
                if firestoreConnector.filtersalesArray.count  == 0 {
                    VStack{
                        Spacer()
                        HStack{
                            Spacer()
                    ...
                    ScrollView(showsIndicators: false){
                        VStack{
                            Spacer(minLength: 45)
                            ForEach(firestoreConnector.filtersalesArray){sale in
                ...
                HStack{
                    Button {
                        ...
                        case 0:
                            ...
                            firestoreConnector.filtersalesArray = firestoreConnector.filtersalesArray.sorted(by: {
            ...
            }.opacity(showConfirmation ? 0.6 : 1).onAppear{
                firestoreConnector.fetchAccount {
                    firestoreConnector.pullSales(SaleID: firestoreConnector.dataToDisplay.sales)
                }
                tapCount = 0
                ...
                FilterPage(itemSelect: $itemSelect, bulkSelect: $bulkSelect, newSelect: $newSelect, usedSelect: $usedSelect, shipSelect: $shipSelect, localSelect: $localSelect, minSelect: $minSelect, maxSelect: $maxSelect, descending: $descending)
                    .onDisappear{
                        firestoreConnector.filterSale(Sales: true, itemSelect: itemSelect, bulkSelect: bulkSelect, newSelect: newSelect, usedSelect: usedSelect, shipSelect: shipSelect, localSelect: localSelect, minSelect: minSelect, maxSelect: maxSelect, descending: descending)
                    }
            }.overlay{
                if showConfirmation{
