...
//  Looper
//
//  Created by Samuel Ridet on 12/25/22.
//

import SwiftUI

struct LogChatSeller: View {
    ...
    var body: some View {
        ...
        GeometryReader { geometry in
            ...
            ScrollView (showsIndicators: false){
                VStack(alignment: .leading) {
                    ...
                    VStack(alignment:.leading, spacing: 10){
                        ...
                        HStack {
                            ...
                            HStack {
                                ...
                                TextField("100", text: $boughtPrice)
                                    .limitInputLength(value: $boughtPrice, length: 5)
                                    .font(.custom("Montserrat-SemiBold", size: 15))
                ...
                }.confirmationDialog("", isPresented: $confirmationDialogShow) {
                    Button("Log and delete this listing", role: .destructive){
                        firestoreConnector.logSale(type: "Sale", prodName: itemName, sku: itemSKU, size: itemSizeNum, sizeList: sizeList, price: itemPrice, buyer: buyerName, date: date, boughtPrice: boughtPrice, payment: paymentMethod, deliveryMethod: deliveryMethod, address: address, tracking: tracking, image: listingData.images.first as? String ?? "", productCat: itemSizeCat, otherUser: userProfile.id, condition: condition, delete: true, listingID: listingData.id)
                    ...
                    Button("Log and mark this listing as sold"){
                ...
                Text("Do you want to log and delete this listing?")
            }
...
struct LogChatSellerDemo: View {
    ...
    @State var listing = feedInfo(id: "dgfsdgs", username: "french_soles", productName: "Jordan 1 Volt", productSKU: "DHJSA-334", productSize:"9M" , productCat: "9", productPrice: "230", productCondition: "New", productDelivery: "Local meetup", city: "Chicago", state: "IL", shipping: "15", time: "3458235290375", postType: "Bulk", atype: " ", caption: "Loopin like we like it", likes: [], saves: [], comments: [], images: [], userID: "", bulkSize: [["size": "9", "category": "M", "quantity": "2", "price": "200"], ["size": "11", "category": "M", "quantity": "2", "price": "200"]], rating: "", Nameimages: [])
    ...
    var body: some View {
        ...
        NavigationView {
            LogChatSeller(listingData: listing, chat: chat, offerPrice: "300", userProfile: account, showConfirmation: $show, exitNext: $show)
        }
    }
}
struct LogChatSeller_Previews: PreviewProvider {
